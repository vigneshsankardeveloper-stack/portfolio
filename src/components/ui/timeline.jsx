...
export const Timeline = ({
  ...
  return (
    <div
      className="w-full bg-transparent dark:bg-neutral-950 font-sans md:px-10  dark:border-neutral-800 mt-10 md:pt-20 "
      ref={containerRef}>
      <div className="max-w-7xl mx-auto py-10 px-4 md:px-8 lg:px-10">
        ...
        <p
          ...
          {"A timeline of my professional experience from 2019 to present."}
        </p>
      </div>
